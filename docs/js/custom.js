...
jQuery('.nav').onePageNav({
    ...
    jQuery('.align-center a').click(function(){
...
/*----------------------------------------------------*/
    ...
    //Google map
    jQuery('#maps').gMap({
        address: "Lodge At Sunspot, Sunspot Way, Winter Park, CO",
        zoom: 10,
        controls: {
         panControl: true,
         zoomControl: true,
        ...
        markers: [{
            latitude: 39.874801,
            longitude: -105.775966,
            html: "<h4>The Lodge at Sunspot</h4>Winter Park, CO",
            popup: true
        }]
    });
